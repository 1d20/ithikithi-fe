...
describe('CamelCaseInterceptor', () => {
  ...
  it ('should request be cloned', () => {
    ...
    result.subscribe(res => expect(res).not.toBe(httpRequest, 'request is not cloned'));
  });
